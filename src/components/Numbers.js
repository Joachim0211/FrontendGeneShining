                            ...
                            <div class="row first-row" style={{margin: '0px 10px'}}>
                                <div class="col s12 m4 l3">
                                    <div class="card blue-grey lighten-1">
                                        ...
                                        <div class="card-action">
                                            <p style={{fontSize: 20, color: '#fff'}}>{analysisData.timeCounter}  {`(${analysisData.timeCounterPC}%)`}<br></br>{analysisData.number1}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col s12 m4 l3">
                                    <div class="card blue-grey lighten-1">
                                        ...
                                        <div class="card-action">
                                            <p style={{fontSize: 20, color: '#fff'}}>{analysisData.number2}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col s12 m4 l3">
                                    <div class="card blue-grey lighten-1">
                                        ...
                                        <div class="card-action">
                                            <p style={{fontSize: 20, color: '#fff'}}>{analysisData.number3}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col s12 m4 l3">
                                    <div class="card blue-grey lighten-1">
                                        ...
                                        <div class="card-action">
                                            <p style={{fontSize: 20, color: '#fff'}}>{analysisData.number4} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row second-row">
                                <div class="col s12 m4 l6 offset-l3">
                                    <div class="card green main-card">
                                        ...
                                        <div class="card-action">
                                            <p >{analysisData.mainNumber > 0 ? <p style={{fontSize: 16, }}>Your organism develops potassium deficiency. <span style={{fontSize: 20, fontWeight: 500, color: '#fff'}}>{analysisData.mainNumber}</span></p> : <p style={{fontSize: 16}}>GeneShining indicates whether the organism develops a desease. <span style={{fontSize: 20, fontWeight: 500, color: '#fff'}}>{analysisData.mainNumber}</span></p>}</p>
                                        </div>
                                    </div>
                                </div>
